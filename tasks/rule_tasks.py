    ...
    "step_info": [
        {
            ...
            "command": {
                "pre_check": [
                    ...
                    {"command": "xxxx", "rollback_command": "", "desc": ""}
                ],
                "exe_command": [
                    {"command": "mmi-mode enable", "rollback_command": "mmi-mode enable", "desc": ""},
                    {"command": "system-view", "rollback_command": "system-view", "desc": ""},
                    {"command": "undo ssl policy router_default", "rollback_command": "ssl policy router_default", "desc": ""},
                    {"command": "undo ssl cipher-suite-list default_cipher_suite", "rollback_command": "ssl cipher-suite-list default_cipher_suite", "desc": ""},
                    {"command": "undo local-user root", "rollback_command": "local-user root password irreversible-cipher Changeme_123", "desc": ""},
                    {"command": "undo local-user admin123", "rollback_command": "local-user root service-type ssh mml", "desc": ""},
                    {"command": "quit", "rollback_command": "quit", "desc": ""},
                    {"command": "commit", "rollback_command": "commit", "desc": ""},
                    {"command": "return", "rollback_command": "return", "desc": ""},
        ...
        },
        {
            ...
            "command": {
                "pre_check": [
                    {"command": "display current-configuration interface Eth-Trunk 120", "rollback_command": "", "desc": ""},
                    {"command": "display current-configuration interface 100GE1/0/61", "rollback_command": "", "desc": ""},
                    {"command": "display current-configuration interface 100GE1/0/62", "rollback_command": "", "desc": ""},
                    {"command": "display current-configuration interface 100GE1/0/63", "rollback_command": "", "desc": ""},
                    {"command": "display current-configuration interface 100GE1/0/64", "rollback_command": "", "desc": ""},
                    {"command": "xxxx", "rollback_command": "", "desc": ""}
                ],
                "exe_command": [
                    {"command": "mmi-mode enable", "rollback_command": "mmi-mode enable", "desc": ""},
                    {"command": "system-view", "rollback_command": "system-view", "desc": ""},
                    {"command": "interface Eth-Trunk120", "rollback_command": "undo interface Eth-Trunk120", "desc": ""},
                    {"command": "description TO_PGW01-99.99236.94/PGW02-99.99.236.95", "rollback_command": "", "desc": ""},
                    {"command": "port link-type hybrid", "rollback_command": "", "desc": ""},
                    {"command": "port hybrid untagged vlan 1000", "rollback_command": "", "desc": ""},
                    {"command": "port vlan-stacking vlan 2 to 4063 stack-vlan 1000", "rollback_command": "", "desc": ""},
                    {"command": "stp disable", "rollback_command": "", "desc": ""},
                    {"command": "mac-address learning disable", "rollback_command": "", "desc": ""},
                    {"command": "quit", "rollback_command": "quit", "desc": ""},
                    {"command": "interface 100GE1/0/61", "rollback_command": "interface 100GE1/0/61", "desc": ""},
                    {"command": "description TO_CN-NJ-NKG-NE8000F1A-TRANSITWAN-P02-PGW01-99.99.236.94_100GE0/1/50", "rollback_command": "description l60058710-0617-pgw", "desc": ""},
