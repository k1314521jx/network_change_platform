    ...
    "step_info": [
        {
            ...
            "command": {
                ...
                "exe_command": [
                    ...
                    {"command": "undo ssl policy router_default", "rollback_command": "ssl policy router_default",
                     "desc": ""},
                    {"command": "undo ssl cipher-suite-list default_cipher_suite",
                     "rollback_command": "ssl cipher-suite-list default_cipher_suite", "desc": ""},
                    {"command": "undo local-user root",
                     "rollback_command": "local-user root password irreversible-cipher Changeme_123", "desc": ""},
                    {"command": "undo local-user admin123", "rollback_command": "local-user root service-type ssh mml",
                     "desc": ""},
        ...
        },
        {
            ...
            "command": {
                ...
                "exe_command": [
                    {"command": "mmi-mode enable", "rollback_command": "mmi-mode enable", "desc": ""},
                    {"command": "system-view", "rollback_command": "system-view", "desc": ""},
                    {"command": "interface Eth-Trunk120", "rollback_command": "undo interface Eth-Trunk120",
                     "desc": ""},
                    {"command": "description TO_PGW01-99.99236.94/PGW02-99.99.236.95", "rollback_command": "",
                     "desc": ""},
                    {"command": "port link-type hybrid", "rollback_command": "", "desc": ""},
                    {"command": "port hybrid untagged vlan 1000", "rollback_command": "", "desc": ""},
                    {"command": "port vlan-stacking vlan 2 to 4063 stack-vlan 1000", "rollback_command": "",
                     "desc": ""},
